...
### Treatment figure
plot(1973:1991, fit_diff_in_diff$Y_true, type = "l", lty = 2, ylim = c(0, 35000), xlim = c(1973,1991), col = "red", main = "Mariel Boatlift: Log Weekly Wages", xlab = "Year", ylab = "", las = 1, bty = 'L')
